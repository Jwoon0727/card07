...
<ClientNavbar />
  ...
  useEffect(() => {
    ...
    const createMap = () => {
      if (window.kakao && window.kakao.maps) {
        ...
        const options = {
          center: new window.kakao.maps.LatLng(36.8396345, 127.1426990), // 초기 중심 좌표 (36.8396345, 127.1426990)
          level: 3,
        };
  ...
  return (
    <div>
        <ClientNavbar/>
    <div style={{ width: '100%', height: '30vh', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
